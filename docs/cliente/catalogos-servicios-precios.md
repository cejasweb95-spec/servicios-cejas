...
> 📌 **Sobre "Duración" en las tablas de abajo:** se refiere a cuánto **dura el resultado** en la piel (permanencia), NO al tiempo de la sesión.
...
## EXTENSIONES DE PESTAÑAS *(solo catálogo Colombia)*

Los 9 sets, según el panel visual del catálogo (pág. 10):
...
| Volumen griego 3D | $140.000 | $70.000 | $90.000 |
| Volumen griego 5D | $150.000 | $80.000 | $100.000 |
| Por punto efecto volumen | $40.000 | — | — |
| Por punto mega volumen | $50.000 | — | — |

> ✅ **Confirmado por la cliente:** el noveno set es **"volumen griego 5D"** (la etiqueta "inglés 5D" del panel de fotos era un error del catálogo).
...
## UÑAS *(solo catálogo Colombia)*

| Servicio | Precio CO |
|---|---|
| Manicure tradicional | $22.000 |
| Pedicure tradicional | $27.000 |
| Manicure + pedicure | $45.000 |
| Manicure semipermanente | $55.000 |
| Pedicure semipermanente | $55.000 |
| Base rubber | $67.000 |
| Dipping | $75.000 |
| Press on | $100.000 (retoque $90.000) |
| Acrílico esculpido | $140.000 (retoque $100.000) |
| Acrílico cubrimiento | $120.000 (retoque $90.000) |
| Retiro acrílico | $25.000 |
| Retiro semipermanente | $20.000 |
| Retiro press on | $25.000 |

---

## PEINADOS Y MAQUILLAJE *(solo catálogo Colombia)*

| Servicio | Precio CO |
|---|---|
| Maquillaje social | $95.000 |
| Peinado social | $45.000 |
| Trenzas | $15.000 (cotizar según referencia) |

---

## NOTAS CLAVE DEL CATÁLOGO

- Si tienes procedimientos de otro lugar → enviar foto sin maquillaje para **valoración gratuita**.
- Si tienes dudas sobre qué procedimiento es adecuado → foto sin maquillaje para **valoración gratuita**.
- No se realizan retoques de otro lugar (uñas).
- Enviar decorado de uñas para determinar tiempo de cita.
- Algunos servicios requieren imagen de referencia para cotizar (trenzas, peinado).

---

## RESUMEN PARA LA WEB

**Servicios estrella (core del negocio):**
1. Micropigmentación de cejas (efecto polvo, efecto maquillaje, híbridas, corrección)
2. Micropigmentación de labios (neutralización, microlips, hidralips)
3. Micropigmentación de mirada (eyeliner, relleno de pestañas)
4. Lifting de pestañas
5. Cejas con henna + depilación

**Servicios complementarios (presentes en Colombia):**
- Extensiones de pestañas (gama completa)
