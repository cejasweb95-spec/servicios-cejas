...
export function HeaderWordmark({
  ...
  return (
    ...
    >
      ...
      <span className="inline-flex flex-col items-end gap-y-0.5 font-header-brand text-[0.5625rem] font-medium uppercase leading-none tracking-[0.16em] text-foreground sm:text-[0.625rem] sm:tracking-[0.18em]">
        <span>{byline}</span>
        <span>{surname}</span>
      </span>
    </span>
