...
export function generateStaticParams() {
  return getCourses("en").map((course) => ({
    locale: "en",
    course: course.slug,
  }));
}
...
export async function generateMetadata({
  ...
  const spanishCourse = getCourseById(course.id, "es");
  ...
  return buildPageMetadata({
    ...
    alternates: {
      es: spanishCourse ? buildCoursePath("es", spanishCourse.slug) : courseBasePath.es,
      en: buildCoursePath("en", course.slug),
    },
  });
}
